    ...
    <div id={id} className='relative sm:px-16 px-6 sm:pt-[10rem] pt-30'>
      <div className='flex flex-row ' >
        <div className='flex sm:pl-50 flex-row'>
          <img src="/images/decagramStar.png" alt='decagram-star' className='h-auto sm:w-14 w-6' />
      ...
      <section className="sm:pl-50 grid grid-cols-1 sm:grid-cols-[0.8fr_1fr_1fr] items-center">
        ...
        {/* Image */}
        <div className="sm:block hidden img-hover-zoom w-[12rem] h-[25rem] sm:w-[18rem] sm:h-[33rem] sm:pt-0 pt-6 cursor-pointer order-2 sm:order-2">
          <a href="https://paul-kaldi-coffee.vercel.app/home">
            <img className="w-full h-full" src="/images/works-1.jpg" alt="paul-kaldi" />
          </a>
        </div>
      </section>
      ...
      <section className='sm:pl-50 grid grid-cols-1 sm:grid-cols-[0.9fr_2fr] items-center'>
        <div className='img-hover-zoom w-[20rem] h-[11.7rem] sm:w-[30rem] sm:h-[17rem] cursor-pointer mt-8 sm:mt-26 '>
          <a href='https://binhi.wvsu.edu.ph/'>
            <img className='h-full w-full' src="/images/works-2.png" alt='BINHI website' />
          </a>
        </div>
      ...
      <section className='sm:pl-50 grid grid-cols-1 sm:grid-cols-[8fr_5fr] items-center'>
        <div className='img-hover-zoom w-[20rem] h-[11.7rem] sm:w-[30rem] sm:h-[17rem] cursor-pointer mt-8 sm:mt-26 justify-self-auto sm:justify-self-end'>
          <a href='https://cict.wvsu-fundays.com/'>
            <img className='w-full h-full' src="/images/works-3.png" alt='CICT Fundays'></img>
          </a>
        </div>
      ...
      <section className='sm:pl-50 grid grid-cols-1 sm:grid-cols-[3fr_1fr] items-center'>
        ...
        <div className='img-hover-zoom w-[20rem] h-[11.7rem] sm:w-[35rem] sm:h-[20rem] cursor-pointer mt-8 sm:mt-26 '>
          <a href='https://wvsu-usc.org/'>
            <img className='w-full h-full' src="/images/works-4.png" alt='USC CITE'></img>
          </a>
        </div>
      </section>
    </div>
